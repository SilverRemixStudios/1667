...
public class WorldGenBeechTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.LOG_BEECH.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumWoodType.BEECH);
	
	private final int minHeight;
	
	public WorldGenBeechTree() 
	{
		super(false);
		this.minHeight = 12;
	}
