...
{
	public static final IBlockState LOG = BlockInit.LOG_REDWOOD.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumWoodType.REDWOOD);
