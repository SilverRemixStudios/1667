package srs1667.world.gen.generators;
...
public class WorldGenWalnutTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.LOG_WALNUT.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumWoodType.WALNUT);
	
	private final int minHeight;
	
	public WorldGenWalnutTree() 
	{
		super(false);
		this.minHeight = 12;
	}
