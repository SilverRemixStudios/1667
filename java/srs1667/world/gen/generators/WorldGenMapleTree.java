...
{
	public static final IBlockState LOG = BlockInit.LOG_MAPLE.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumWoodType.MAPLE);
